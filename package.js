...
module.exports = {
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/deploy-demo/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called deploy-demo which is linked to
    //./bin/deploy-demo in the local package.

    //If we have installed this package globally using npm install deploy-demo
    //-g we will be able to call this new command deploy-demo from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/deploy-demo.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/deploy-demo.js"
    }
};
